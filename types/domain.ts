 ...
 *
 * Keeping these pure + framework-free means they can move into a shared package
 * when the React Native app is built, and the same shapes are produced by the
 * Supabase seed script later.
 */
